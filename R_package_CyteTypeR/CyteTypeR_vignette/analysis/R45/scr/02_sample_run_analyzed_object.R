...
# output:
out_id_rds <- "../../out/R45/object/pbmc_CyteTypeR.rds"
out_id_varsh5 <- "../../out/R45/object/vars.h5"
out_id_duckdb <- "../../out/R45/object/obs.duckdb"
out_id_filename <- "../../out/R45/object/query.json"
